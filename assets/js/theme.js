        ...
        initGoogleMap: function() {
            ...
            function initialize() {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 15,
                    center: new google.maps.LatLng(10.7725768,106.7026732) // map coordinates
                };
                map = new google.maps.Map(document.getElementById('map-canvas'),
                    mapOptions);
                marker = new google.maps.Marker({
                    position: new google.maps.LatLng(10.7725768,106.7026732), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Hello World!'
                });
